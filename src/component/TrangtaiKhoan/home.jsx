...
import { faRightFromBracket,faCartShopping,faUser,faGears,faLocationDot,faTruckFast } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="w-full h-fit bg-[hsl(204,45%,98%)]">
      <div className="w-[100%] top-5 m-auto p-10 pt-20 flex flex-row gap-10 ">
        <nav className="flex gap-0 flex-col shadow-lg shadow-slate-300 w-[20%] m-auto bg-white rounded-md h-[500px]">
          {arr.map((el, index) => (
            <li
              className=" hover:after:block transition duration-150  hover:after:absolute relative hover:after:content-[''] hover:after:rounded-md hover:after:z-0
            ...
            >
              ...
              >
                {el.name}
                <span className="font-bold text-2xl"><FontAwesomeIcon icon={el.icon}/></span>
              </Link>
            </li>
          ))}
          <div
